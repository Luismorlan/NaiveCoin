...
public class Transaction {
    ...
    /** 创建一个Coinbase Transaction，只包含一个Transaction output，为挖矿奖励 */
    ...
    /**
     * Transaction需要签名的数据
     * @param index 第几个Input（因为是Input在claim UTXO，所以Input需要签名）
     * @return 数字签名
     */
